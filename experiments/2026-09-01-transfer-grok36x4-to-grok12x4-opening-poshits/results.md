...
|---|---|---|---|---|---|
| poshits | 6/48 | 38/48 | 39/3 | 3/7 | 0.929 |
...
|---|---|---|---|---|---|---|
| poshits | in-sample-youden | 0.0000 | 39/48 | 45/48 | 0.812 | 0.938 |
| poshits | nested-youden | 0.0000 | 39/48 | 45/48 | 0.812 | 0.938 |
| poshits | nested-fpr10 | 0.0000 | 39/48 | 45/48 | 0.812 | 0.938 |

poshits auc=0.869 mean_pos=1.5025 mean_neg=-0.0653 diff=1.5679 pos>0=39/48 neg<=0=45/48 perm_p=0.0004998 binom_p=7.611e-06 youden_t=0.0000 youden_sens=0.812 youden_spec=0.938 J=0.750
poshits zeros=6/48 vs 38/48 decided_tp=39 fn=3 fp=3 tn=7 precision=0.929 decided_acc=0.885
poshits prompts_marked_above=12/12 ranking_without_isolated_tp=0/12 ranking_losses_with_isolated_tp=0 instance=key-free-poshits used_keys=False
