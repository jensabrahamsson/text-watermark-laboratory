...
|---|---|---|---|---|---|---|---|---|---|
| 2026-09-01-pair-gpt2-medium-100x4 | 100 | 64 | postokhits | 13/48 | 10/48 | 3 | 0 | 0 | 1.000 |

Zeros on the full combined train:

### postokhits (35 marked zeros)
...
- `03-library` draw 1: The map is a
- `03-library` draw 2: The map is a
- `03-library` draw 3: The map is a
- `03-library` draw 4: The map is a
- `04-market` draw 1: The dog's nose
- `04-market` draw 2: The dog jumped up
- `04-market` draw 3: The dog's nose
- `04-market` draw 4: The dog's nose
...
- `09-workshop` draw 1: The teacher had called
- `09-workshop` draw 2: The teacher had called
- `09-workshop` draw 3: After a long night
- `09-workshop` draw 4: The teacher had called
