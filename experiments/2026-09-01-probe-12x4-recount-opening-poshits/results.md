...
|---|---|---|---|---|---|---|
| poshits | 9/12 | 0.672 | 23/48 | 48/48 | 0.0004998 | 1.0931 |

| method | marked zeros | unmarked zeros | decided tp/fn | decided fp/tn | precision |
|---|---|---|---|---|---|
| poshits | 9/48 | 33/48 | 23/16 | 0/15 | 1.000 |

| method | nested-youden-by-stem marked>t | unmarked<=t | mean t | sens | spec |
|---|---|---|---|---|---|
| poshits | 23/48 | 48/48 | 0.0000 | 0.479 | 1.000 |

poshits auc=0.672 mean_pos=0.9596 mean_neg=-0.1335 diff=1.0931 pos>0=23/48 neg<=0=48/48 perm_p=0.0004998 binom_p=0.6673 youden_t=0.0000 youden_sens=0.479 youden_spec=1.000 J=0.479
