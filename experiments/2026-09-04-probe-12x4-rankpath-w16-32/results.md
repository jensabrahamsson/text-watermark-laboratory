...
probe n_methods=1 pair_dir=experiments/2026-08-17-pair-12x4 context_len=4 model=gpt2 max_draws=None prefix_lens=[] windows=['16:32'] fit_prefix=32 pos_bucket=1 rankpath_full=False rankpath_pos_bucket=1 cascade_rankpath_end=None cascade_when=coverage include_first=False prompt_context=False used_keys=False hash_iv=False g_values=False
...
|---|---|---|---|---|---|---|
| rankpath | 10/12 | 0.695 | 28/48 | 34/48 | 0.0004998 | 0.1406 |

| method | prompt wins | ranking wins with no isolated TP | ranking losses with isolated TP |
|---|---|---|---|
| rankpath | 10/12 | 0/10 | 1 (02-night-bus) |
...
|---|---|---|---|---|---|
| rankpath | 0/48 | 0/48 | 28/20 | 14/34 | 0.667 |

| method | nested-youden-by-stem marked>t | unmarked<=t | mean t | sens | spec |
|---|---|---|---|---|---|
| rankpath | 31/48 | 33/48 | -0.0175 | 0.646 | 0.688 |

| window tokens | method | prompt wins | file auc | nested-by-stem marked | unmarked |
|---|---|---|---|---|---|
| 16:32 | rankpath | 7/12 | 0.506 | 9/48 | 28/48 |

rankpath auc=0.695 mean_pos=0.0470 mean_neg=-0.0936 diff=0.1406 pos>0=28/48 neg<=0=34/48 perm_p=0.0004998 (file-level, descriptive) binom_p=0.1562 (file-level, descriptive) youden_t=-0.0174 youden_sens=0.646 youden_spec=0.708 J=0.354
