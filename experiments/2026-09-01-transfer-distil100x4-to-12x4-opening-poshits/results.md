...
|---|---|---|---|---|---|---|
| poshits | 11/12 | 0.760 | 39/48 | 24/48 | 0.0004998 | 0.5409 |
| postokhits | 10/12 | 0.717 | 22/48 | 43/48 | 0.0004998 | 0.5438 |

| method | prompt wins | ranking wins with no isolated TP | ranking losses with isolated TP |
|---|---|---|---|
| poshits | 11/12 | 1/11 (03-library) | 1 (11-garden) |
| postokhits | 10/12 | 4/10 (02-night-bus, 03-library, 08-letter, 12-ferry-queue) | 0 |
...
|---|---|---|---|---|---|
| poshits | 8/48 | 13/48 | 39/1 | 24/11 | 0.619 |
| postokhits | 25/48 | 36/48 | 22/1 | 5/7 | 0.815 |
...
|---|---|---|---|---|---|---|
| poshits | in-sample-youden | -0.0591 | 47/48 | 7/48 | 0.979 | 0.146 |
| postokhits | in-sample-youden | -0.0591 | 47/48 | 7/48 | 0.979 | 0.146 |
| poshits | nested-youden | -0.0015 | 47/48 | 11/48 | 0.979 | 0.229 |
| poshits | nested-fpr10 | 0.1513 | 22/48 | 44/48 | 0.458 | 0.917 |
| postokhits | nested-youden | -0.0026 | 47/48 | 7/48 | 0.979 | 0.146 |
| postokhits | nested-fpr10 | 0.3034 | 22/48 | 44/48 | 0.458 | 0.917 |

poshits auc=0.760 mean_pos=0.3943 mean_neg=-0.1467 diff=0.5409 pos>0=39/48 neg<=0=24/48 perm_p=0.0004998 binom_p=7.611e-06 youden_t=0.0122 youden_sens=0.792 youden_spec=0.646 J=0.438
poshits zeros=8/48 vs 13/48 decided_tp=39 fn=1 fp=24 tn=11 precision=0.619 decided_acc=0.667
poshits prompts_marked_above=11/12 ranking_without_isolated_tp=1/11 ranking_losses_with_isolated_tp=1 instance=key-free-poshits used_keys=False
postokhits auc=0.717 mean_pos=0.4038 mean_neg=-0.1400 diff=0.5438 pos>0=22/48 neg<=0=43/48 perm_p=0.0004998 binom_p=0.7646 youden_t=0.0897 youden_sens=0.458 youden_spec=0.917 J=0.375
postokhits zeros=25/48 vs 36/48 decided_tp=22 fn=1 fp=5 tn=7 precision=0.815 decided_acc=0.829
postokhits prompts_marked_above=10/12 ranking_without_isolated_tp=4/10 ranking_losses_with_isolated_tp=0 instance=key-free-postokhits used_keys=False
