...
|---|---|---|---|---|---|---|
| interpolate | 12/12 | 0.833 | 39/48 | 33/48 | 0.0004998 | 0.3088 |
...
|---|---|---|---|---|---|
| interpolate | 0/48 | 0/48 | 39/9 | 15/33 | 0.722 |
...
|---|---|---|---|---|---|---|
| interpolate | in-sample-youden | 0.0000 | 39/48 | 33/48 | 0.812 | 0.688 |
| interpolate | nested-youden | 0.0484 | 36/48 | 39/48 | 0.750 | 0.812 |
| interpolate | nested-fpr10 | 0.1473 | 32/48 | 43/48 | 0.667 | 0.896 |

interpolate auc=0.833 mean_pos=0.2378 mean_neg=-0.0710 diff=0.3088 pos>0=39/48 neg<=0=33/48 perm_p=0.0004998 binom_p=7.611e-06 youden_t=0.0488 youden_sens=0.750 youden_spec=0.833 J=0.583
interpolate zeros=0/48 vs 0/48 decided_tp=39 fn=9 fp=15 tn=33 precision=0.722 decided_acc=0.750
