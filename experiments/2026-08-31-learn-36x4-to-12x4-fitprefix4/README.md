...
This is the 4-token new-topic gate. Count-table poshits on the same split
is **12/12**, AUC **0.873**, t=0 **39/48 vs 41/48**. The learned scorers
below do **not** beat that. They do not use keys. They are not a
universal detector.
