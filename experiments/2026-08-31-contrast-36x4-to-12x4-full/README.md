...
**Result (full 128-token files).** poshits control `lr>0` stays **0/48**.
Unbucketed hits on the full file is **not** the instance sign: control
`lr>0` **29/48**, AUC vs unmarked **0.475**. Write-up:
