...
**Result (4-token poshits, 24 other 36×4 stems → 12×4).** Control-shuffled-30
isolated `lr>0` is **0/48**. Public vs unmarked is still **12/12**, AUC
**0.873**, t=0 **39/48 vs 41/48**. Public vs control is **12/12**, AUC
**0.906**, all 48 control files `≤ 0`. Hits on the opening is also **0/48**.
Hashpool leaks (**6/48**). Not key recovery. Not a replacement of 10/12 or
29/48. Write-up: [../../research/key-free-contrast.md](../../research/key-free-contrast.md).
