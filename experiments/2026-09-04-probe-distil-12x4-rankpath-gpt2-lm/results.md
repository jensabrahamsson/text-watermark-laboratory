...
|---|---|---|---|---|---|---|
| rankpath | 6/12 | 0.532 | 24/48 | 27/48 | 0.2729 | 0.0730 |

| method | prompt wins | ranking wins with no isolated TP | ranking losses with isolated TP |
|---|---|---|---|
| rankpath | 6/12 | 0/6 | 3 (01-harbour, 11-garden, 12-ferry-queue) |
...
|---|---|---|---|---|---|
| rankpath | 0/48 | 0/48 | 24/24 | 21/27 | 0.533 |

| method | nested-youden-by-stem marked>t | unmarked<=t | mean t | sens | spec |
|---|---|---|---|---|---|
| rankpath | 16/48 | 34/48 | 0.2880 | 0.333 | 0.708 |

rankpath auc=0.532 mean_pos=0.0601 mean_neg=-0.0129 diff=0.0730 pos>0=24/48 neg<=0=27/48 perm_p=0.2729 (file-level, descriptive) binom_p=0.5573 (file-level, descriptive) youden_t=0.2786 youden_sens=0.438 youden_spec=0.708 J=0.146
