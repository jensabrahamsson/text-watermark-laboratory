...
|---|---|---|---|---|---|---|
| poshits | 6/12 | 0.558 | 11/48 | 39/48 | 0.006497 | 0.3439 |
| postokhits | 6/12 | 0.561 | 3/48 | 47/48 | 0.005497 | 0.3564 |

| method | prompt wins | ranking wins with no isolated TP | ranking losses with isolated TP |
|---|---|---|---|
| poshits | 6/12 | 1/6 (03-library) | 0 |
| postokhits | 6/12 | 3/6 (03-library, 06-station, 08-letter) | 0 |
...
|---|---|---|---|---|---|
| poshits | 35/48 | 33/48 | 11/2 | 9/6 | 0.550 |
| postokhits | 43/48 | 41/48 | 3/2 | 1/6 | 0.750 |
...
|---|---|---|---|---|---|---|
| poshits | in-sample-youden | 0.5488 | 3/48 | 48/48 | 0.062 | 1.000 |
| postokhits | in-sample-youden | 0.5488 | 3/48 | 47/48 | 0.062 | 0.979 |
| poshits | nested-youden | 1.1256 | 3/48 | 48/48 | 0.062 | 1.000 |
| poshits | nested-fpr10 | 0.1313 | 11/48 | 39/48 | 0.229 | 0.812 |
| postokhits | nested-youden | 1.1256 | 3/48 | 48/48 | 0.062 | 1.000 |
| postokhits | nested-fpr10 | 0.0000 | 3/48 | 47/48 | 0.062 | 0.979 |

poshits auc=0.558 mean_pos=0.2023 mean_neg=-0.1415 diff=0.3439 pos>0=11/48 neg<=0=39/48 perm_p=0.006497 (file-level, descriptive) binom_p=1 (file-level, descriptive) youden_t=-0.9649 youden_sens=1.000 youden_spec=0.104 J=0.104
poshits zeros=35/48 vs 33/48 decided_tp=11 fn=2 fp=9 tn=6 precision=0.550 decided_acc=0.607
poshits prompts_marked_above=6/12 ranking_without_isolated_tp=1/6 ranking_losses_with_isolated_tp=0 instance=key-free-poshits used_keys=False
postokhits auc=0.561 mean_pos=0.1800 mean_neg=-0.1763 diff=0.3564 pos>0=3/48 neg<=0=47/48 perm_p=0.005497 (file-level, descriptive) binom_p=1 (file-level, descriptive) youden_t=-0.9649 youden_sens=1.000 youden_spec=0.104 J=0.104
postokhits zeros=43/48 vs 41/48 decided_tp=3 fn=2 fp=1 tn=6 precision=0.750 decided_acc=0.750
postokhits prompts_marked_above=6/12 ranking_without_isolated_tp=3/6 ranking_losses_with_isolated_tp=0 instance=key-free-postokhits used_keys=False
