...
probe n_methods=1 pair_dir=experiments/2026-09-01-pair-100x4 context_len=4 model=gpt2 max_draws=None prefix_lens=[] windows=['64:128'] fit_prefix=None pos_bucket=16 rankpath_full=False rankpath_pos_bucket=None cascade_rankpath_end=None cascade_when=coverage include_first=False prompt_context=False used_keys=False hash_iv=False g_values=False
...
|---|---|---|---|---|---|
| 64:128 | interpolate | 93/100 | 0.726 | 181/400 | 342/400 |
