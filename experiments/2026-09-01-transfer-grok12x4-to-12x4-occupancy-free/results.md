...
|---|---|---|---|---|---|
| postokhits | 43/48 | 47/48 | 5/0 | 1/0 | 0.833 |
...
|---|---|---|---|---|---|---|
| postokhits | in-sample-youden | 0.0000 | 5/48 | 47/48 | 0.104 | 0.979 |
| postokhits | nested-youden | 0.0000 | 5/48 | 47/48 | 0.104 | 0.979 |
| postokhits | nested-fpr10 | 0.0000 | 5/48 | 47/48 | 0.104 | 0.979 |

postokhits auc=0.541 mean_pos=0.1866 mean_neg=0.0229 diff=0.1637 pos>0=5/48 neg<=0=47/48 perm_p=0.07046 binom_p=1 youden_t=0.0000 youden_sens=0.104 youden_spec=0.979 J=0.083
postokhits zeros=43/48 vs 47/48 decided_tp=5 fn=0 fp=1 tn=0 precision=0.833 decided_acc=0.833
postokhits prompts_marked_above=11/12 ranking_without_isolated_tp=9/11 ranking_losses_with_isolated_tp=0 instance=key-free-postokhits used_keys=False
