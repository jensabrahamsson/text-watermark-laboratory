...
probe n_methods=1 pair_dir=/workspace/experiments/2026-08-31-pair-36x4 context_len=4 model=gpt2 max_draws=None prefix_lens=[] windows=[] fit_prefix=16 pos_bucket=4 used_keys=False hash_iv=False g_values=False
