...
probe n_methods=1 pair_dir=experiments/2026-09-01-pair-gpt2-medium-12x4 context_len=4 model=gpt2 max_draws=None prefix_lens=[] windows=['4:16'] fit_prefix=16 pos_bucket=1 rankpath_full=False rankpath_pos_bucket=1 cascade_rankpath_end=None cascade_when=coverage include_first=False prompt_context=False used_keys=False hash_iv=False g_values=False
...
|---|---|---|---|---|---|---|
| rankpath | 8/12 | 0.609 | 25/48 | 31/48 | 0.07796 | 0.0688 |

| method | prompt wins | ranking wins with no isolated TP | ranking losses with isolated TP |
|---|---|---|---|
| rankpath | 8/12 | 0/8 | 3 (04-market, 09-workshop, 11-garden) |
...
|---|---|---|---|---|---|
| rankpath | 24/48 | 36/48 | 0.0250 | 0.500 | 0.750 |

| window tokens | method | prompt wins | file auc | nested-by-stem marked | unmarked |
|---|---|---|---|---|---|
| 4:16 | rankpath | 8/12 | 0.624 | 25/48 | 28/48 |

rankpath auc=0.609 mean_pos=-0.0068 mean_neg=-0.0756 diff=0.0688 pos>0=25/48 neg<=0=31/48 perm_p=0.07796 (file-level, descriptive) binom_p=0.4427 (file-level, descriptive) youden_t=0.0254 youden_sens=0.521 youden_spec=0.771 J=0.292
