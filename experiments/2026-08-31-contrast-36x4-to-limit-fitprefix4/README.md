...
**Result (4-token, 12×1×700 pair-limit).** poshits/hits control `lr>0` is
**0/12**. Public vs control **12/12**, AUC **0.917**. Hashpool 4-token
control AUC 0.750 is leakage (see the 12×4 pile). Write-up:
