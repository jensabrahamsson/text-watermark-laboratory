...
probe n_methods=1 pair_dir=experiments/2026-08-17-pair-12x4 context_len=4 model=gpt2 max_draws=None prefix_lens=[] windows=['4:16'] fit_prefix=16 pos_bucket=1 rankpath_full=False rankpath_pos_bucket=1 cascade_rankpath_end=None cascade_when=coverage include_first=False prompt_context=False used_keys=False hash_iv=False g_values=False
...
|---|---|---|---|---|---|---|
| rankpath | 10/12 | 0.749 | 29/48 | 36/48 | 0.0004998 | 0.2526 |

| method | prompt wins | ranking wins with no isolated TP | ranking losses with isolated TP |
|---|---|---|---|
| rankpath | 10/12 | 1/10 (04-market) | 1 (02-night-bus) |
...
|---|---|---|---|---|---|
| rankpath | 0/48 | 0/48 | 29/19 | 12/36 | 0.707 |

| method | nested-youden-by-stem marked>t | unmarked<=t | mean t | sens | spec |
|---|---|---|---|---|---|
| rankpath | 26/48 | 37/48 | 0.0109 | 0.542 | 0.771 |

| window tokens | method | prompt wins | file auc | nested-by-stem marked | unmarked |
|---|---|---|---|---|---|
| 4:16 | rankpath | 7/12 | 0.430 | 2/48 | 43/48 |

rankpath auc=0.749 mean_pos=0.0929 mean_neg=-0.1597 diff=0.2526 pos>0=29/48 neg<=0=36/48 perm_p=0.0004998 (file-level, descriptive) binom_p=0.09671 (file-level, descriptive) youden_t=-0.0097 youden_sens=0.667 youden_spec=0.750 J=0.417
