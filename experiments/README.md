...
| `2026-09-04-probe-medium-12x4-rankpath-w4-16/` | gpt2-medium native rankpath `[4:16)` on medium 12 | ranking **6/12**, isolated **20/48 vs 30/48**; not **25/48** |
| `2026-09-04-probe-distil-12x4-rankpath-gpt2-w4-16/` | GPT-2-small LM rankpath `[4:16)` on Distil 12 | ranking **4/12**, isolated **26/48 vs 21/48**; not **25/48** |
| `2026-09-04-probe-medium-12x4-rankpath-distil-w4-16/` | Distil LM rankpath `[4:16)` on medium 12 | ranking **11/12**, isolated **25/48 vs 33/48**; not **25/48** |
| `2026-09-04-probe-medium-12x4-rankpath-gpt2-w4-16/` | GPT-2-small LM rankpath `[4:16)` on medium 12 | ranking **8/12**, isolated **28/48 vs 30/48**; not **25/48** |
| `2026-09-04-probe-distil-12x4-rankpath-medium-w4-16/` | gpt2-medium LM rankpath `[4:16)` on Distil 12 | ranking **9/12**, isolated **32/48 vs 25/48**; not **25/48** |
