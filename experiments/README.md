...
| `2026-09-01-probe-12x4-fitprefix4-hashtok/` | In-domain `--fit-prefix 4` occupancy-free hashing | tokhits **23/48 vs 48/48** (prompt **12/12**); hashtok **24/48 vs 47/48** (letter d3 extra; nested **23/48 vs 47/48**); hashtok2 **22/48 vs 48/48**; marked recall below hard **29/48**; sparse like tokhits, not rankpath **41/48** |
