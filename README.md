...
Out-of-family, the same frozen tables score the original 12×4 files at lock A nested Youden **23/48 vs 38/48** (prompt ranking **8/12**) — that does not beat **25/48**. Opening poshits ranks **11/12** with nested Youden **36/48 vs 42/48**; occupancy-free readout of those tables is **16/48 vs 48/48** (21 of the poshits TPs were Laplace-on-unseen). Isolated observed-token recall equals train opening-atom overlap: **18/48** covered on those 12 files (14 exact 4-token copies), **117/144** on the 36-topic pool. Do not sell that coverage as replacing **25/48**. On the 36-topic pool (same one-line register), lock A nested Youden is **109/144 vs 122/144** (prompt **36/36**). Protocol: [research/PROTOCOL-isolated.md](research/PROTOCOL-isolated.md).
