...
This lab did **not** invent key-free watermark detection. Canonical map: [research/related-work.md](research/related-work.md).

[TTP-Detect](https://arxiv.org/abs/2603.14968) (*Rethinking LLM Watermark Detection in Black-Box Settings*) formulates third-party, key-agnostic verification from observable outputs and paired watermarked/unwatermarked reference sets — the same audit problem, a different method. Earlier watermark-stealing and probing work learns structure from black-box samples. [ETH/SRI’s SynthID probe](https://www.sri.inf.ethz.ch/blog/probingsynthid) ([Sabanayagam, Hörl, Dobriban 2024](https://arxiv.org/abs/2405.20777)) shows that SynthID-Text can be detected as a *generator property* with repeated fixed-context queries. That is not the same measurement as scoring a finished string against count tables. [Omidi, Dong, and Wang, arXiv:2603.03410](https://arxiv.org/abs/2603.03410) analyse SynthID-Text’s **keyed** mean and Bayesian scores (unimodal TPR in tournament layers; Bernoulli 0.5 optimal). That is official g-value detection, not `indicate`. [PVMark, arXiv:2510.26274](https://arxiv.org/abs/2510.26274) proves keyed detection in zero knowledge; the detector still uses the key.
