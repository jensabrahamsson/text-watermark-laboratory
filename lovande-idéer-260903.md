...
16:32 **97/100**.
Existing `hits` (shared 4-grams only, no Witten–Bell backoff) on the
same GPT-2 KGW mid slices is **not** that body reader
(`used_keys=false`):
...
Last-4 shared 4-gram `hits` is not that mid-file reader. GPT-2 last-4
hits 4:16 is chance where last-4 interpolate is already **95/100**.
Distil last-4 hits 4:16 still ranks **66/100** and stays below
interpolate **88/100**. Existing last-4 `hashpool` sits **between**
hits and interpolate (`used_keys=false`): 4:16 **72/100**, AUC
**0.611**, isolated **257/400**; 16:32 **85/100**, **0.690**,
**259/400**; 32:64 **87/100**, **0.734**, **259/400**. Hashing
recovers some of the mid leak that shared 4-grams miss and is still
below interpolate **95/100** / **97/100** / **99/100**. Do not
leftover-target GPT-2 ranking-only zeros. Isolated $\tau=0$ still
fails. Do not sell hits 32:64 **80/100**, Distil hits 4:16
**66/100**, or hashpool 4:16 **72/100**.

Matching `hits` / `hashpool` width to Kirchenbauer `context_width=1`
(idea 2) recovers that same mid-file body on GPT-2 and Distil
(`used_keys=false`, `--skip-nested`; isolated from `holdout.md`, not
nested-by-stem):

| Window | last-4 interpolate | last-4 hits | last-1 hits | last-1 interpolate | last-1 hashpool |
|---|---|---|---|---|---|
| GPT-2 4:16 | **95/100**, 0.771, 289/400 | 45/100 chance, 26/400 | **96/100**, 0.853, **314/400** | 92/100, 0.777, **296/400** | **98/100**, 0.852, **318/400** |
| GPT-2 16:32 | **97/100**, 0.817, 304/400 | 68/100, 58/400 | **99/100**, 0.905, **341/400** | 95/100, 0.833, **316/400** | **99/100**, 0.905, **334/400** |
| GPT-2 32:64 | **99/100**, 0.897, 342/400 | 80/100, 109/400 | **100/100**, 0.951, **360/400** | 100/100, 0.902, **350/400** | **100/100**, 0.947, **362/400** |
| Distil 4:16 | **88/100**, 0.728, 303/400 | 66/100, 182/400 | **97/100**, 0.812, **316/400** | 91/100, 0.741, **306/400** | **99/100**, 0.806, **300/400** |
| Distil 16:32 | **92/100**, 0.753, 300/400 | 71/100, 167/400 | **100/100**, 0.825, **321/400** | 91/100, 0.763, **312/400** | **99/100**, 0.823, **307/400** |
| Distil 32:64 | **98/100**, 0.818, 320/400 | 79/100, 196/400 | **99/100**, 0.854, **328/400** | 98/100, 0.825, **324/400** | **99/100**, 0.845, **310/400** |

Last-4 hits 4:16 was chance **45/100** on GPT-2 and **66/100** on
Distil; last-1 hits is **96/100** / **97/100**. Last-1 interpolate
4:16 sits slightly **below** last-4 interpolate on GPT-2
(**92/100** vs **95/100**) and slightly **above** it on Distil
(**91/100** vs **88/100**). Hits/hashpool want last-1 on both
generators; interpolate last-4 remains the ranking winner on GPT-2
4:16. Isolated last-1 hits at 4:16 (**314/400** / **316/400**) beats
...
**93/100** / **252/400**. Last-2 `interpolate` on those same slices
sits with last-4 interpolate, **not** with the hits last-2 jump
(`used_keys=false`, `--skip-nested`; isolated from `holdout.md`):

| Corpus | last-4 interpolate | last-2 interpolate | last-1 interpolate |
|---|---|---|---|
| GPT-2 4:16 | **95/100**, 0.771, **289/400** | **97/100**, 0.784, **290/400** | 92/100, 0.777, **296/400** |
| Distil 4:16 | **88/100**, 0.728, **303/400** | 89/100, 0.734, **302/400** | **91/100**, 0.741, **306/400** |

Hits last-4 4:16 was chance **45/100** then last-2 **96/100**. Interpolate last-4 was already **95/100**; last-2 isolated **290/400** equals last-4 **289/400**. Distil last-2 interpolate **89/100** / **302/400** equals last-4 **88/100** / **303/400**. The width match is `hits` / `hashpool` / `hard`, not interpolate. GPT-2 last-2 interpolate has **1** ranking-only and **3** ranking losses with isolated TP; Distil has **11** losses. Later windows last-2 interpolate stay with last-4 interpolate (back-loaded body), not a second reader (`used_keys=false`, `--skip-nested`; isolated from `holdout.md`):

| Corpus | last-4 interpolate | last-2 interpolate | last-2 hits |
|---|---|---|---|
| GPT-2 16:32 | **97/100**, 0.817, **304/400** | **98/100**, 0.821, **309/400** | **97/100**, 0.840, **309/400** |
| GPT-2 32:64 | **99/100**, 0.897, **342/400** | **100/100**, 0.903, **349/400** | **100/100**, 0.904, **340/400** |
...
| Distil 4:16 | **97/100**, 0.812, **316/400** | **99/100**, 0.806, **300/400** | **98/100**, 0.798, **295/400** | 92/100, 0.753, **247/400** |

Last-1 hashtok isolated **314/400** equals last-1 hits on GPT-2. Distil ranking **98/100** sits with last-1 hits **97/100**; isolated **295/400** sits with last-1 hashpool **300/400**, below last-1 hits **316/400**. Last-2 hashtok ranking **92/100** sits with last-2 hits **96/100** / isolated **290/400**, below last-1. Later windows last-1 hashtok stay with last-1 hits (back-loaded body), not opening-only (`used_keys=false`, `--skip-nested`; isolated from `holdout.md`):

| Corpus | last-1 hits | last-1 hashtok |
|---|---|---|
| GPT-2 16:32 | **99/100**, 0.905, **341/400** | **99/100**, 0.896, **333/400** |
| GPT-2 32:64 | **100/100**, 0.951, **360/400** | **100/100**, 0.939, **358/400** |
| Distil 16:32 | **100/100**, 0.825, **321/400** | **98/100**, 0.821, **296/400** |
| Distil 32:64 | **99/100**, 0.854, **328/400** | **99/100**, 0.842, **300/400** |

GPT-2 last-1 hashtok 16:32 **99/100** equals last-1 hits. Distil ranking **98/100** sits with last-1 hits **100/100**; isolated **296/400** sits below last-1 hits **321/400**, same hashpool-vs-hits split as 4:16. Distil last-2 hashtok 4:16 ranking **92/100** sits with last-2 hits **93/100**; isolated **247/400** (**6** ranking-only, **7** ranking losses with isolated TP) sits with last-2 hashpool **252/400**, below last-1 hashtok **295/400**. Occupancy-free last-1 hashing is a body reader when not using `--fit-prefix`. Existing `hashtok2` (min_count=2; not a new method; do not pass `--skip-hashpool`) sits with last-1 hashtok on GPT-2 KGW 4:16 (**96/100**, 0.837, **312/400** vs **98/100**, **314/400**); 16:32 **98/100**, **333/400** equals last-1 hashtok isolated. Distil last-1 hashtok2 4:16 is **98/100**, 0.803, **294/400** versus last-1 hashtok **98/100**, **295/400**; 16:32 **98/100**, **293/400** sits with last-1 hashtok **296/400**. Occupancy-free last-1 body is not a singleton core. Last-2 `hashtok2` without `--fit-prefix` sits with last-2 hashtok on that same KGW mid-file body (`used_keys=false`; isolated from `holdout.md`): GPT-2 4:16 **92/100**, 0.735, **280/400** (**7** ranking losses) versus last-2 hashtok **92/100**, 0.744, **277/400**; Distil 4:16 **90/100**, 0.749, **262/400** (**2** ranking-only, **9** ranking losses) versus last-2 hashtok **92/100**, **247/400**. 16:32 stays a body reader (GPT-2 last-2 hashtok2 **96/100**, 0.815, **314/400** equals last-2 hashtok **96/100**, **307/400**; Distil **94/100**, 0.751, **254/400** equals last-2 hashtok **94/100**, **247/400**), unlike public SynthID last-2 drop. Last-2 hashtok 32:64 on those same dumps still ranks the body (GPT-2 **98/100**, 0.874, **322/400**; Distil **97/100**, 0.788, **240/400**, **5** ranking-only), below last-1 hashtok 32:64 isolated (**358/400** / Distil **300/400**) and still back-loaded. Last-2 `hashpool` 32:64 sits with that body (GPT-2 **100/100**, 0.898, **333/400**; Distil **97/100**, 0.796, **253/400**), opposite of public SynthID Distil last-2 hashpool 32:64 **75/100**, **74/400**. Last-2 `hashtok2` 32:64 sits with last-2 hashtok (GPT-2 **98/100**, 0.857, **326/400**, **2** ranking losses versus **98/100**, 0.874, **322/400**; Distil **98/100**, 0.785, **257/400**, **1** ranking-only versus **97/100**, **240/400**). Occupancy-free last-2 KGW hashing is not a singleton core and is still a body, not an opening. In-domain hashtok2 on the original 12 was a sign reshuffle; this 100-family last-1 mid is not that. The empty last-1 hashtok in this file is `--fit-prefix 1` (opening occupancy-free unigrams), not this mid-file reader. Do not switch hashtok to last-2 thinking last-1 is empty. GPT-2 4:16 last-1 hashtok has **2** ranking losses with isolated TP; Distil has **1** ranking-only and **2** losses. Do not leftover-target those zeros. Do not sell last-1 hashtok 4:16 **98/100** / **314/400** / Distil **295/400**, 16:32 **99/100** / Distil **98/100**, last-2 Distil **247/400**, hashtok2 **96/100** / **312/400**, Distil hashtok2 **98/100** / **294/400**, last-2 hashtok2 GPT-2 **92/100** / **280/400**, Distil last-2 hashtok2 **90/100** / **262/400**, last-2 hashtok2 16:32 **96/100** / Distil **94/100**, or last-2 hashtok 32:64 **98/100** / **322/400** / Distil **97/100** / **240/400** or last-2 hashpool 32:64 **100/100** / **333/400** / Distil **97/100** / **253/400** or last-2 hashtok2 32:64 GPT-2 **98/100** / **326/400** / Distil **98/100** / **257/400**.
...
or last-1 `hits` / `hashpool` (idea 2 width), not last-4 shared
4-gram `hits`.
...
**66/100**. Do not sell GPT-2 hashpool 4:16 **72/100**. Do not sell
last-1 hits 4:16 **96/100** / isolated **314/400**, last-1 hashpool
...
python3 -m text_watermark_tools probe experiments/2026-09-03-pair-100x4-kgw \
  --methods interpolate,hits --context-len 1 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-100x4-kgw-interp-hits-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-03-pair-100x4-kgw \
  --methods hashpool --context-len 1 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-100x4-kgw-hashpool-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-03-pair-distil-100x4-kgw \
  --model gpt2 --methods interpolate,hits --context-len 1 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-kgw-interp-hits-k1-mid
...
python3 -m text_watermark_tools probe experiments/2026-09-03-pair-distil-100x4-kgw \
  ...
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-kgw-hashtok-k1-mid
...
python3 -m text_watermark_tools probe experiments/2026-09-03-pair-distil-100x4-kgw \
  ...
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-kgw-hashtok-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-03-pair-100x4-kgw \
  --methods hashtok2 --context-len 1 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-100x4-kgw-hashtok2-k1-mid
...
python3 -m text_watermark_tools probe experiments/2026-09-03-pair-distil-100x4-kgw \
  ...
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-kgw-interp-k2-mid
...
|---|---|---|
| GPT-2 4:16 | **100/100**, 0.988, **380/400** | 78/100, 0.850, **304/400** |
| GPT-2 16:32 | **99/100**, 0.983, **372/400** | 73/100, 0.783, **232/400** |
| GPT-2 32:64 | **100/100**, 0.985, **368/400** | 84/100, 0.834, **276/400** |
| Distil 4:16 | **97/100**, 0.934, **376/400** | 80/100, 0.849, **324/400** |
| Distil 16:32 | **97/100**, 0.949, **380/400** | 71/100, 0.791, **276/400** |
| Distil 32:64 | **96/100**, 0.942, **372/400** | 66/100, 0.740, **256/400** |
| Qwen 4:16 | **97/100**, 0.970, **356/400** | 25/100 chance, 0.548, **12/400** |
| Qwen 16:32 | **100/100**, 0.979, **340/400** | 31/100 chance, 0.555, **36/400** |
| Qwen 32:64 | **100/100**, 0.994, **372/400** | 33/100 chance, 0.559, **44/400** |

Last-1 hits is a **mid-file** Aaronson body reader on GPT-2, Distil,
and Qwen, not only the 0:4 / 64:128 ends. Qwen last-4 hits mid is
...
| Corpus | last-2 hits | last-2 hard | last-1 hard |
|---|---|---|---|
| GPT-2 4:16 | 98/100, 0.973, **388/400** | 94/100, 0.928, **376/400** | **99/100**, 0.976, **384/400** |
| Distil 4:16 | 91/100, 0.902, **368/400** | 92/100, 0.870, **368/400** | 94/100, 0.917, **376/400** |
| Qwen 4:16 | 91/100, 0.854, **276/400** | 64/100, 0.582, **292/400** | **97/100**, 0.932, **360/400** |

GPT-2 / Distil last-2 hard still ranks. Qwen last-2 hard is weak
(**64/100**, unmarked $\le 0$ only **140/400**, **14** ranking losses
with isolated TP); last-2 hits recovers **91/100**. GPT-2 last-2 hard
unmarked $\le 0$ **245/400** vs last-1 hard **349/400**. Opposite of
Kirchenbauer last-2 hard 4:16 **55/100**. Do not leftover-target those
zeros. Do not sell last-2 hard 4:16 **94/100** / **376/400** / Qwen
**64/100**. Last-2 `hashpool` on those same slices **ranks** with
last-2 hits, not last-2 hard (`used_keys=false`; isolated from
`holdout.md`; `--skip-hashpool` would drop this reader):

| Corpus | last-2 hits | last-2 hashpool | last-2 hard |
|---|---|---|---|
| GPT-2 4:16 | 98/100, 0.973, **388/400** | **99/100**, 0.985, **348/400** | 94/100, 0.928, **376/400** |
| Distil 4:16 | 91/100, 0.902, **368/400** | 95/100, 0.922, **360/400** | 92/100, 0.870, **368/400** |
| Qwen 4:16 | 91/100, 0.854, **276/400** | **96/100**, 0.914, **236/400** | 64/100, 0.582, **292/400** |

Qwen last-2 hashpool ranking **96/100** recovers from last-2 hard
**64/100** and sits with last-2 hits **91/100**. Isolated is weaker
than hits (Qwen **236/400** vs **276/400**, **37** ranking-only;
GPT-2 **348/400** vs **388/400**, **12** ranking-only). Distil
ranking **95/100** sits above last-2 hits **91/100** with isolated
**360/400** vs **368/400** — opposite of Kirchenbauer last-2 hashpool
Distil isolated drop (**252/400** vs hits **303/400**). Unmarked
$\le 0$ on last-2 hashpool is last-1-hashpool-like (GPT-2 **399/400**;
Qwen **397/400**) versus last-2 hits (GPT-2 **309/400**; Qwen
**297/400**). Hits remains the tighter isolated reader at width 2.
Qwen 16:32 last-2 hashpool still ranks **96/100** with isolated
**216/400** (file-level binom $p\approx 0.06$, chance) and **42**
ranking-only: that ranking is not $\tau=0$. Do not leftover-target
those zeros. Do not sell last-2 hashpool 4:16 **99/100** / **96/100**
/ **348/400** / **236/400** or 16:32 **96/100**. Last-2 `interpolate`
on those same Aaronson 4:16 slices **ranks** with last-1 interpolate,
not with last-2 hits isolated (`used_keys=false`, `--skip-nested`;
isolated from `holdout.md`):

| Corpus | last-2 hits | last-2 interpolate | last-1 interpolate |
|---|---|---|---|
| GPT-2 4:16 | 98/100, 0.973, **388/400** | **98/100**, 0.977, **280/400** | **99/100**, 0.984, **312/400** |
| Distil 4:16 | 91/100, 0.902, **368/400** | **96/100**, 0.908, **300/400** | **96/100**, 0.918, **320/400** |
| Qwen 4:16 | 91/100, 0.854, **276/400** | **95/100**, 0.938, **224/400** | **95/100**, 0.942, **244/400** |

GPT-2 last-2 interpolate isolated **280/400** sits between last-1
interpolate **312/400** (**21** ranking-only) and last-4 interpolate
**248/400** (**36** ranking-only), with **28** ranking-only and unmarked
$\le 0$ **400/400**. Distil last-2 interpolate ranking **96/100**
matches last-1 interpolate; isolated **300/400** (**24** ranking-only)
is below last-2 hits **368/400**. Qwen ranking **95/100** matches last-1
interpolate with isolated **224/400** (**39** ranking-only) below last-2
hits **276/400**. Interpolate is ranking-without-isolated-TP at every
width. Hits remains the isolated last-2 reader. Later windows stay
that split (`used_keys=false`, `--skip-nested`; isolated from
`holdout.md`; last-4 interpolate 16:32 from `--context-len 4` mid dumps):

| Corpus | last-2 hits | last-2 interpolate | last-4 interpolate |
|---|---|---|---|
| GPT-2 16:32 | **99/100**, 0.966, **372/400** | **97/100**, 0.970, **276/400** | 96/100, 0.967, **240/400** |
| Distil 16:32 | 92/100, 0.901, **368/400** | **95/100**, 0.912, **292/400** | 95/100, 0.902, **276/400** |
| Qwen 16:32 | 93/100, 0.874, **296/400** | **97/100**, 0.952, **236/400** | 97/100, 0.942, **212/400** |

GPT-2 last-2 interpolate 16:32 isolated **276/400** has **28** ranking-only (same as 4:16 **28/98**); last-2 hits isolated **372/400** has **6**. Distil last-2 interpolate 16:32 ranking **95/100** matches last-4 interpolate with **25** ranking-only. Qwen last-2 interpolate 16:32 **97/100** matches last-4 interpolate ranking with isolated **236/400** (**38** ranking-only) below last-2 hits **296/400**. Interpolate later windows are still ranking-without-isolated-TP. Hits remains the isolated last-2 reader. Do not leftover-target those ranking-only zeros. Do not sell last-2 interpolate **98/100** /
**280/400** / Distil **96/100** / **300/400** / Qwen **224/400** or 16:32 **97/100** / **276/400** / Qwen **236/400**. Do not sell last-1 4:16
...
the opened Qwen 100 interpolate last-4 freeze (**216/400 vs 400/400**,
BA **616/800** on `main`; occupancy, not last-1 hits). Do not sell
**216/400** or **616/800**. Last-1 `hashpool` on those same Aaronson
mid slices **ranks** with hits (GPT-2 4:16 **100/100**, Distil
**97/100**, Qwen **98/100**; AUCs 0.988 / 0.929 / 0.972) but isolated
is weaker, especially Qwen (hashpool 4:16 **312/400** vs hits
**356/400**, **20** ranking-only). GPT-2 hashpool 4:16 isolated
**364/400** vs hits **380/400**, **9** ranking-only; Distil
**364/400** vs hits **376/400**, **9** ranking-only. Hits is tighter
than hashpool isolated. That is the opposite of Kirchenbauer 4:16,
where last-1 hashpool slightly beat hits ranking (**98/100** vs
**96/100**). Last-1 `hard` on the same Aaronson mid slices sits with
hits, not with hashpool’s weaker isolated (`used_keys=false`,
`--skip-nested`; isolated from `holdout.md`):

| Window | last-1 hits | last-1 hard | last-1 hashpool |
|---|---|---|---|
| GPT-2 4:16 | **100/100**, 0.988, **380/400** | 99/100, 0.976, **384/400** | **100/100**, 0.988, **364/400** |
| GPT-2 16:32 | **99/100**, 0.983, **372/400** | 99/100, 0.977, **380/400** | **99/100**, 0.980, **360/400** |
| GPT-2 32:64 | **100/100**, 0.985, **368/400** | 98/100, 0.975, **380/400** | **100/100**, 0.986, **352/400** |
| Distil 4:16 | **97/100**, 0.934, **376/400** | 94/100, 0.917, **376/400** | **97/100**, 0.929, **364/400** |
| Distil 16:32 | **97/100**, 0.949, **380/400** | 95/100, 0.919, **372/400** | **97/100**, 0.938, **360/400** |
| Distil 32:64 | **96/100**, 0.942, **372/400** | 91/100, 0.911, **364/400** | **96/100**, 0.928, **356/400** |
| Qwen 4:16 | **97/100**, 0.970, **356/400** | **97/100**, 0.932, **360/400** | 98/100, 0.972, **312/400** |
| Qwen 16:32 | **100/100**, 0.979, **340/400** | 98/100, 0.942, **348/400** | **100/100**, 0.985, **320/400** |
| Qwen 32:64 | **100/100**, 0.994, **372/400** | 97/100, 0.968, **372/400** | **100/100**, 0.994, **352/400** |

Hits and hard are the isolated Aaronson mid-file readers; hashpool
ranks with them and drops isolated, especially Qwen 4:16 (**312/400**,
**20** ranking-only). Distil last-1 hard 4:16 ranking **94/100** sits
below hits **97/100** with the same isolated **376/400**. Qwen hard
16:32 has **11** ranking-only. Last-4 `hard` on those same mid slices
still ranks GPT-2 / Distil (4:16 **92/100** / **92/100**, isolated
**328/400** / **344/400**) but sits below last-1 hard (**99/100** /
**384/400**; Distil **94/100** / **376/400**). Qwen last-4 hard 4:16 is
...
width match. Last-4 interpolate on those same slices still ranks
(GPT-2 4:16 **98/100**, Distil **95/100**, Qwen **93/100**) with
weaker isolated than last-1 interpolate (GPT-2 **248/400** vs
**312/400**, **36** ranking-only; Qwen **188/400** vs **244/400**,
**46** ranking-only). Opposite of Kirchenbauer 4:16, where last-4
...
n. Do not sell **379/400**. The same last-1 `hits` / `hashpool` width
match is a **mid-file** body lift on GPT-2 and Distil 100, not only
those 0:4 vs 64:128 ends (`used_keys=false`, `--skip-nested`; isolated
from `holdout.md`):
...
Last-4 hits 4:16 was chance **45/100** on GPT-2 and **66/100** on
Distil; last-1 hits recovers **96/100** / **97/100**. Last-1
interpolate 4:16 sits slightly below last-4 interpolate on GPT-2
(**92/100** vs **95/100**) and slightly above it on Distil
(**91/100** vs **88/100**). Hits/hashpool want last-1 on the body;
interpolate last-4 remains the GPT-2 4:16 ranking winner. Isolated
last-1 hits 4:16 **314/400** / **316/400** beats last-4 interpolate
**289/400** / **303/400**. Ranking-without-isolated-TP is **0** on
last-1 hits (Distil last-1 hashpool 4:16 has **1**; do not
...
Last-1 hashtok isolated **364/400** equals last-1 hashpool on GPT-2 (**9** ranking-only, unmarked $\le 0$ **398/400**), below last-1 hits **380/400**. Distil last-1 hashtok ranking **97/100** matches last-1 hits; isolated **360/400** (**10** ranking-only) sits with last-1 hashpool **364/400**. Qwen ranking **94/100** sits with last-1 hits **97/100**; isolated **304/400** (**18** ranking-only) sits with last-1 hashpool **312/400**, below last-1 hits **356/400**. Later windows stay that split: GPT-2 16:32 last-1 hashtok **99/100**, **356/400**, **10** ranking-only versus last-1 hits **99/100**, **372/400**; Distil 16:32 **97/100**, **356/400**, **11** ranking-only; Qwen 16:32 **99/100**, **308/400**, **22** ranking-only. Hits remains the tighter isolated reader. Existing `hashtok2` last-1 (min_count=2; do not pass `--skip-hashpool`) on GPT-2 Aaronson 4:16 is **100/100**, 0.995, **372/400**, **7** ranking-only — slightly tighter isolated than last-1 hashtok **364/400**, nearer last-1 hits **380/400**. Distil last-1 hashtok2 4:16 is **96/100**, 0.933, **364/400**, **8** ranking-only versus last-1 hashtok **97/100**, **360/400**. Qwen last-1 hashtok2 4:16 is **94/100**, 0.940, **312/400**, **16** ranking-only versus last-1 hashtok **94/100**, **304/400**. Occupancy-free last-1 body is not a singleton core. GPT-2 last-2 hashtok isolated **344/400** (**13** ranking-only) is weaker. Distil last-2 hashtok 4:16 is **94/100**, 0.917, **344/400**, **11** ranking-only, below last-1 hashtok **360/400** and last-2 hits **368/400**. Qwen last-2 hashtok 4:16 is **88/100**, 0.861, **212/400**, **35** ranking-only — ranking-without-isolated-TP, below last-1 hashtok **304/400** and last-2 hits **276/400**. Last-2 `hashtok2` sits with last-2 hashtok on GPT-2 (**99/100**, 0.984, **364/400**, **8** ranking-only versus last-2 hashtok **344/400**, **13** ranking-only) and Distil (**94/100**, 0.912, **352/400**, **9** ranking-only versus **344/400**, **11** ranking-only). Qwen last-2 hashtok2 4:16 is **89/100**, 0.853, **268/400**, **22** ranking-only versus last-2 hashtok **88/100**, **212/400**, **35** ranking-only — min_count=2 recovers some isolated versus last-2 hashtok, still ranking-without-isolated-TP, still below last-1 hashtok **304/400**. Last-2 hashtok 32:64 stays that Qwen split (ranking **95/100**, 0.935, isolated **208/400**, **43** ranking-only) versus last-1 hashtok 32:64 **100/100**, 0.991, **324/400**, **19** ranking-only. GPT-2 last-2 hashtok 32:64 **96/100**, **320/400** sits below last-1 **100/100**, **348/400**; Distil **90/100**, **320/400** below last-1 **96/100**, **348/400**. Last-2 `hashpool` 32:64 still ranks that body (GPT-2 **97/100**, 0.973, **320/400**, **17** ranking-only, unmarked $\le 0$ **400/400**; Distil **92/100**, 0.911, **332/400**, **12** ranking-only) versus last-2 hits (GPT-2 **99/100**, 0.970, **368/400**; Distil **95/100**, 0.899, **356/400**; Qwen **95/100**, 0.944, **356/400**). Qwen last-2 hashpool 32:64 ranking **99/100**, 0.966, isolated **240/400**, **39** ranking-only versus last-2 hashtok **95/100**, **208/400**, **43** ranking-only and last-1 hashpool 32:64 **100/100**, 0.994, **352/400**. Last-2 `hashtok2` 32:64 sits with last-2 hashtok on GPT-2 (**96/100**, 0.957, **332/400**, **13** ranking-only versus last-2 hashtok **96/100**, **320/400**) and Distil (**89/100**, 0.889, **324/400** versus **90/100**, **320/400**). Qwen last-2 hashtok2 32:64 ranking **94/100**, 0.925, isolated **320/400**, **14** ranking-only recovers from last-2 hashtok chance isolated **208/400**, **43** ranking-only (file-level binom $p\approx 0.23$) and sits with last-1 hashtok 32:64 **324/400**, still below last-2 hits **356/400**. min_count=2 is not a singleton core on GPT-2 / Distil; on Qwen 32:64 it is the occupancy-free last-2 body, not a reason to drop last-1. Ranking without isolated TP continues on last-2 hashtok / hashpool; last-1 remains the default occupancy-free width. Do not switch hashtok to last-2 hashtok2. Do not leftover-target those ranking-only zeros. Do not sell Qwen last-2 hashtok 32:64 **95/100** / **208/400** or last-2 hashpool 32:64 **99/100** / **240/400** or last-2 hashtok2 32:64 **94/100** / **320/400**. Do not treat `--fit-prefix 1` emptiness as evidence that occupancy-free hashing cannot read last-1. Do not switch hashtok to last-2. Do not leftover-target those ranking-only zeros. Do not sell last-1 hashtok 4:16 **100/100** / **364/400** / Distil **360/400** / Qwen **94/100** / **304/400** or 16:32 **356/400** / Qwen **308/400** or hashtok2 **372/400** / Distil **364/400** / Qwen **312/400** or Distil last-2 hashtok **94/100** / **344/400** or Qwen last-2 hashtok **88/100** / **212/400** or GPT-2 last-2 hashtok2 **99/100** / **364/400** or Distil last-2 hashtok2 **94/100** / **352/400** or Qwen last-2 hashtok2 **89/100** / **268/400** or Qwen last-2 hashtok 32:64 **95/100** / **208/400** or last-2 hashpool 32:64 GPT-2 **97/100** / **320/400** / Distil **92/100** / **332/400** / Qwen **99/100** / **240/400** or last-2 hashtok2 32:64 GPT-2 **96/100** / **332/400** / Distil **89/100** / **324/400** / Qwen **94/100** / **320/400**. Qwen last-1 hashtok2 full-file ranking **100/100** / AUC **1.000** / isolated **388/400** is occupancy-free hashing, not the opened interpolate last-4 freeze. Do not sell that AUC **1.000**. Qwen last-1 hashtok full-file ranking **100/100** / AUC **1.000** is occupancy-free hashing, not the opened interpolate last-4 freeze. Do not sell AUC **1.000**. Last-4 `hashtok` (no
...
**72/100**). Aaronson last-2 hard still ranks on GPT-2 / Distil 4:16
(**94/100** / **92/100**) and is weak on Qwen (**64/100**); last-2
hits recovers Qwen **91/100**. Last-2 `hashpool` ranks with last-2
hits, not last-2 hard (Aaronson Qwen 4:16 **96/100** vs hard
**64/100**; Kirchenbauer GPT-2 **94/100** vs hard **55/100**). Isolated
hashpool is weaker than hits (Aaronson Qwen **236/400**, **37**
ranking-only). A context-free unigram still ranks those mid slices
...
and 64:128 rank, including last-1 `hits` (tail **11/12**, **40/48**;
   ...
   **78/100** with **15** ranking-only at 16:32). Last-1 hashpool ranks
...
**46/48** / **395/400**, KGW hits last-1 4:16 **96/100** / isolated
...
**91/100** / **276/400**, Aaronson last-2 hard 4:16 **94/100** / Qwen
**64/100**, unigram 4:16 **82/100** / isolated **270/400**, Distil
...
**380/400**, Distil Aaronson last-1 hits 4:16 **97/100** / isolated
**376/400**, last-4 hits 4:16 **78/100** / Distil **80/100** / Qwen
**25/100**, Qwen last-1 hits full-file **388/400** / AUC **1.000**,
...
hits 4:16 **96/100** / **345/400**, or Qwen last-2 hits 4:16
**79/100**. Do not sell Qwen last-1 hits
...
python3 -m text_watermark_tools probe experiments/2026-09-04-pair-distil-100x4-aaronson \
  ...
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-aaronson-hits-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-distil-100x4-aaronson \
  --model gpt2 --methods hits --context-len 4 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-aaronson-hits-k4-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-qwen-100x4-aaronson \
  --model Qwen/Qwen2-1.5B-Instruct --methods hits --context-len 1 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-aaronson-hits-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-qwen-100x4-aaronson \
  --model Qwen/Qwen2-1.5B-Instruct --methods hits --context-len 4 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-aaronson-hits-k4-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-100x4-aaronson \
  --methods hashpool --context-len 1 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-100x4-aaronson-hashpool-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-distil-100x4-aaronson \
  --model gpt2 --methods hashpool --context-len 1 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-aaronson-hashpool-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-qwen-100x4-aaronson \
  --model Qwen/Qwen2-1.5B-Instruct --methods hashpool --context-len 1 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-aaronson-hashpool-k1-mid
...
python3 -m text_watermark_tools probe experiments/2026-09-04-pair-distil-100x4-aaronson \
  --model gpt2 --methods hashtok --context-len 1 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-aaronson-hashtok-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-qwen-100x4-aaronson \
  --model Qwen/Qwen2-1.5B-Instruct --methods hashtok --context-len 1 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-aaronson-hashtok-k1-mid
...
python3 -m text_watermark_tools probe experiments/2026-09-04-pair-distil-100x4-aaronson \
  --model gpt2 --methods hashtok --context-len 2 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-aaronson-hashtok-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-qwen-100x4-aaronson \
  --model Qwen/Qwen2-1.5B-Instruct --methods hashtok --context-len 2 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-aaronson-hashtok-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-100x4-aaronson \
  --methods hashtok2 --context-len 1 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-100x4-aaronson-hashtok2-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-distil-100x4-aaronson \
  --model gpt2 --methods hashtok2 --context-len 1 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-aaronson-hashtok2-k1-mid
...
python3 -m text_watermark_tools probe experiments/2026-09-04-pair-distil-100x4-aaronson \
  --model gpt2 --methods hashpool --context-len 2 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-aaronson-hashpool-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-qwen-100x4-aaronson \
  --model Qwen/Qwen2-1.5B-Instruct --methods hashpool --context-len 2 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-aaronson-hashpool-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-100x4-aaronson \
  --methods interpolate --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-100x4-aaronson-interp-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-distil-100x4-aaronson \
  --model gpt2 --methods interpolate --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-aaronson-interp-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-qwen-100x4-aaronson \
  --model Qwen/Qwen2-1.5B-Instruct --methods interpolate --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-aaronson-interp-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-100x4-aaronson \
  --methods hard --context-len 1 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-100x4-aaronson-hard-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-distil-100x4-aaronson \
  --model gpt2 --methods hard --context-len 1 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-aaronson-hard-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-qwen-100x4-aaronson \
  --model Qwen/Qwen2-1.5B-Instruct --methods hard --context-len 1 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-aaronson-hard-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-100x4-aaronson \
  --methods hard --context-len 4 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-100x4-aaronson-hard-k4-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-distil-100x4-aaronson \
  --model gpt2 --methods hard --context-len 4 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-aaronson-hard-k4-mid
...
python3 -m text_watermark_tools probe experiments/2026-09-04-pair-100x4-aaronson \
  --methods interpolate --context-len 4 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-100x4-aaronson-interp-k4-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-distil-100x4-aaronson \
  --model gpt2 --methods interpolate --context-len 4 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-aaronson-interp-k4-mid
...
python3 -m text_watermark_tools probe experiments/2026-09-01-pair-distil-100x4 \
  --model gpt2 --methods hashtok --context-len 1 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-synthid-hashtok-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-qwen-100x4 \
  --model Qwen/Qwen2-1.5B-Instruct --methods hashtok --context-len 1 --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-synthid-hashtok-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-distil-100x4 \
  --model gpt2 --methods hits --context-len 1 --skip-hashpool --skip-nested \
  --windows 4:16,16:32 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-synthid-hits-k1-mid
...
python3 -m text_watermark_tools probe experiments/2026-09-01-pair-distil-100x4 \
  --model gpt2 --methods hashtok --context-len 2 --skip-nested \
  --windows 32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-synthid-hashtok-k2-3264

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-qwen-100x4 \
  --model Qwen/Qwen2-1.5B-Instruct --methods hashtok --context-len 2 --skip-nested \
  --windows 32:64 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-synthid-hashtok-k2-3264

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-gpt2-medium-100x4 \
  --model gpt2 --methods hashtok --context-len 2 --skip-nested \
  --windows 32:64 \
  --out-dir /tmp/kgw-lab/probe-medium-100x4-synthid-hashtok-k2-3264

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-100x4 \
  --methods hashtok2 --context-len 2 --skip-nested \
  --windows 4:16,16:32 \
  --out-dir /tmp/kgw-lab/probe-100x4-synthid-hashtok2-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-distil-100x4 \
  --model gpt2 --methods hashtok2 --context-len 2 --skip-nested \
  --windows 4:16,16:32 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-synthid-hashtok2-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-qwen-100x4 \
  --model Qwen/Qwen2-1.5B-Instruct --methods hashtok2 --context-len 2 --skip-nested \
  --windows 4:16,16:32 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-synthid-hashtok2-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-gpt2-medium-100x4 \
  --model gpt2 --methods hashtok2 --context-len 2 --skip-nested \
  --windows 4:16,16:32 \
  --out-dir /tmp/kgw-lab/probe-medium-100x4-synthid-hashtok2-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-100x4 \
  --methods hashtok2 --context-len 1 --skip-nested \
  --windows 4:16,16:32 \
  --out-dir /tmp/kgw-lab/probe-100x4-synthid-hashtok2-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-distil-100x4 \
  --model gpt2 --methods hashtok2 --context-len 1 --skip-nested \
  --windows 4:16,16:32 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-synthid-hashtok2-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-qwen-100x4 \
  --model Qwen/Qwen2-1.5B-Instruct --methods hashtok2 --context-len 1 --skip-nested \
  --windows 4:16,16:32 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-synthid-hashtok2-k1-mid

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-gpt2-medium-100x4 \
  --model gpt2 --methods hashtok2 --context-len 1 --skip-nested \
  --windows 4:16,16:32 \
  --out-dir /tmp/kgw-lab/probe-medium-100x4-synthid-hashtok2-k1-mid
...
python3 -m text_watermark_tools probe experiments/2026-09-01-pair-100x4 \
  --methods interpolate --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-100x4-synthid-interp-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-distil-100x4 \
  --model gpt2 --methods interpolate --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-synthid-interp-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-qwen-100x4 \
  --model Qwen/Qwen2-1.5B-Instruct --methods interpolate --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-synthid-interp-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-01-pair-gpt2-medium-100x4 \
  --model gpt2 --methods interpolate --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-medium-100x4-synthid-interp-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-100x4-aaronson \
  --methods hard --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-100x4-aaronson-hard-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-distil-100x4-aaronson \
  --model gpt2 --methods hard --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-aaronson-hard-k2-mid

python3 -m text_watermark_tools probe experiments/2026-09-04-pair-qwen-100x4-aaronson \
  --model Qwen/Qwen2-1.5B-Instruct --methods hard --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-aaronson-hard-k2-mid
...
| Qwen2-1.5B ngram-13 100×4 | 74/100, 361/400, 0.599 | 76/100, 270/400, 0.611 |
...
**0.795**; 64:128 **60/100**, **214/400**, **0.537**. Mid 4:16 last-2
on those $\Hw=12$ twins is chance (**48/100**, AUC **0.502**, isolated
**197/400**, perm $p=0.44$). Opening 0:4 **87/100** does **not**
survive into 4:16. Public $\Hw=4$ last-2 4:16 still ranked **85/100**.
Lengthening hash history makes last-2 *more* opening-only, not a
Kirchenbauer body. Do not sell $\Hw=12$ last-2 4:16 **48/100**. Full-file
...
Do not sell Qwen last-2 **19/48** or last-1 **22/48**. Qwen2-1.5B
ngram-13 100×4 last-4 hard is the opened freeze (**74/100**,
**361/400**, AUC **0.599**; interpolate last-4 **76/100**, isolated
**273/400**, BA **474/800**). Post-open last-2 (`--skip-nested`) is
**76/100**, **270/400**, **0.611**, **24** ranking losses with isolated
TP — last-2 does **not** beat last-4 ranking and isolated drops.
Absolute windows: 0:4 **81/100**, **322/400**, AUC **0.719**; 4:16
**70/100**, **241/400**, **0.612**; 64:128 **67/100**, **226/400**,
**0.591**. Opening mass, not a Kirchenbauer body. Last-2 ranking
**76/100** is not the interpolate freeze **76/100**. Do not sell last-2
**76/100**, interpolate **76/100**, isolated **270/400**, or opening
**81/100**. Distil
...
**294/400**. gpt2-medium 100 (`--model gpt2`, same BPE) repeats the
split: last-2 4:128 **75/100**, 0.622, **288/400**; last-4 4:128
...
GPT-2 last-1 / last-2 hits. Qwen last-2 hits 4:16 is **79/100**, 0.658,
**242/400** (**17** ranking losses with isolated TP), sitting with
Distil **75/100**, not GPT-2 **100/100**. Near-front is a GPT-2-family hits effect
...
not shorten SynthID `hits`. Last-2 `interpolate` 4:16 on the same GPT-2
100 is **93/100**, AUC **0.804**, isolated **321/400** (last-4 hits
ranking **93/100**, isolated **208/400**; last-2 hits **100/100**,
**350/400**; last-2 hard **85/100**, **314/400**). Distil last-2
interpolate 4:16 is weak (**68/100**, 0.618, isolated **179/400**,
file-level binom $p\approx 0.98$, **24** ranking losses with isolated
TP). Qwen is **73/100**, 0.647, **261/400**, **24** ranking losses.
Interpolate last-2 does not make a Distil/Qwen near-front reader.
gpt2-medium last-2 interpolate 4:16 sits with GPT-2 (**95/100**, 0.805,
**326/400** vs last-2 hits **96/100**, **345/400**). Later windows
last-2 interpolate **drop** like last-2 hits, below last-4 interpolate
([research/PROTOCOL-h2-absolute.md](research/PROTOCOL-h2-absolute.md)
lock A interpolate last-4; `used_keys=false`; last-2 isolated from
`holdout.md`):

| Window | last-4 interpolate | last-2 interpolate | last-2 hits | last-4 hits |
|---|---|---|---|---|
| GPT-2 4:16 | 94/100, 0.803, **314/400** | **93/100**, 0.804, **321/400** | **100/100**, 0.864, **350/400** | 93/100, 0.752, 208/400 |
| GPT-2 16:32 | **87/100**, 0.695, **267/400** | 81/100, 0.674, **262/400** | 82/100, 0.700, **294/400** | **97/100**, 0.743, 211/400 |
| GPT-2 32:64 | 85/100, 0.680, **255/400** | 81/100, 0.642, **242/400** | 88/100, 0.694, **273/400** | **93/100**, 0.776, 249/400 |

Last-2 interpolate 4:16 **93/100** sits with last-4 interpolate
**94/100**, not last-2 hits **100/100**. At 16:32 last-2 interpolate
**81/100** sits with last-2 hits **82/100**, below last-4 interpolate
**87/100** and well below last-4 hits **97/100** (**18** ranking
losses with isolated TP). gpt2-medium last-2 interpolate 16:32
**79/100**, 0.685, **264/400** sits with GPT-2; Distil **65/100**,
0.564, **151/400** and Qwen **65/100**, 0.603, **248/400** stay weak
(**24** and **32** ranking losses with isolated TP at 16:32).
Shortening interpolate to last-2 loses later-window ranking that
last-4 interpolate still has. Interpolate stays last-4. Do not
leftover-target those zeros. Do not sell last-2 interpolate 4:16
...
opposite of Kirchenbauer last-2 hashtok 32:64 **98/100**. Distil last-2
hashtok 32:64 is **71/100**, 0.610, **75/400** (**31** ranking-only,
file-level binom $p=1$). Qwen is **71/100**, 0.598, **273/400** (**25**
...
**95/100**. Isolated is chance (file-level binom $p=1$ on full-file
last-1 hashtok **73/400**). Qwen last-1 hashtok 4:16 is **74/100**,
...
a GPT-2-family near-front, not a Distil isolated rescue. Existing
`hashtok2` (min_count=2; not a new method; do not pass
`--skip-hashpool`) last-2 without `--fit-prefix` sits with last-2
hashtok per generator (`used_keys=false`; isolated from
`holdout.md`):

| Corpus | last-2 hashtok 4:16 | last-2 hashtok2 4:16 |
|---|---|---|
| GPT-2 | **98/100**, 0.860, **345/400** | **98/100**, 0.848, **340/400** (**2** ranking losses) |
| Distil | **73/100**, 0.660, **132/400** | **71/100**, 0.661, **123/400** (**13** ranking-only, **15** ranking losses) |
| Qwen | **79/100**, 0.673, **290/400** | **78/100**, 0.666, **300/400** (**3** ranking-only, **18** ranking losses; unmarked $\le 0$ **180/400**) |
| gpt2-medium | **96/100**, 0.833, **333/400** | **95/100**, 0.822, **326/400** (**4** ranking losses) |

Last-2 occupancy-free hashing is not a singleton core. Distil last-2
hashtok2 isolated **123/400** stays chance (file-level binom $p=1$ on
4:16 and on full-file **62/400**, **41** ranking-only). GPT-2 16:32
last-2 hashtok2 **76/100**, **257/400** drops like last-2 hashtok
**84/100**. Last-1 `hashtok2` without `--fit-prefix` likewise sits
with last-1 hashtok per generator (`used_keys=false`; isolated from
`holdout.md`; do not pass `--skip-hashpool`):

| Corpus | last-1 hashtok 4:16 | last-1 hashtok2 4:16 |
|---|---|---|
| GPT-2 | **95/100**, 0.809, **325/400** | **97/100**, 0.808, **329/400** (**2** ranking losses) |
| Distil | **76/100**, 0.637, **113/400** | **81/100**, 0.639, **112/400** (**16** ranking-only, **9** ranking losses) |
| Qwen | **74/100**, 0.647, **303/400** | **76/100**, 0.660, **313/400** (**1** ranking-only, **18** ranking losses; unmarked $\le 0$ **182/400**) |
| gpt2-medium | **97/100**, 0.805, **323/400** | **95/100**, 0.805, **327/400** (**1** ranking-only, **5** ranking losses) |

Distil last-1 hashtok2 isolated **112/400** stays chance (file-level
binom $p=1$ on 4:16 and on full-file **62/400**, **40** ranking-only).
Ranking **81/100** is slightly above last-1 hashtok **76/100** because
unmarked is more negative, not because isolated rescued. Occupancy-free
hashing is not a singleton core at last-1 or last-2. Do not switch
occupancy-free hashing to last-2 or to `hashtok2`. Do not leftover-target
...
**290/400**, medium last-2 hashtok **96/100** / **333/400**, GPT-2
last-2 hashtok2 **98/100** / **340/400**, Distil last-2 hashtok2
**71/100** / **123/400**, Qwen last-2 hashtok2 **78/100** /
**300/400**, medium last-2 hashtok2 **95/100** / **326/400**, GPT-2
last-1 hashtok2 **97/100** / **329/400**, Distil last-1 hashtok2
**81/100** / **112/400**, Qwen last-1 hashtok2 **76/100** /
**313/400**, or medium last-1 hashtok2 **95/100** / **327/400**. Do not
...
| Window | last-2 hard | last-4 hard |
|---|---|---|
| Distil 4:16 | 58/100, 0.532, 163/400 | 35/100, 0.435, 116/400 |
| Distil 16:32 | 55/100, 0.521, 149/400 | 50/100, 0.506, 149/400 |
| Distil 32:64 | 66/100, 0.541, 165/400 | 59/100, 0.534, 152/400 |
...
**56/100**. Do not sell $\Hw=12$ last-2 4:16 **48/100**.
...
chance); 8:128 **7/12**, **33/48**. Grok36 last-2 4:128 is **24/36**,
isolated **82/144**, AUC **0.545**, perm $p\approx 0.14$ (chance);
8:128 **22/36**, **85/144**. Grok **34/48** / **91/144** do not survive
4:128 the way original-12 last-2 **10/12** / **32/48** does. Do not
sell grok mask **29/48**, **33/48**, **82/144**, or ranking **24/36**. Do not mix grok12 into any train. Do
not sell grok **34/48**.
...
Last-2 `hashtok2` sits with last-2 hashtok (GPT-2 **98/100**,
**340/400**; Distil **71/100**, **123/400** chance; Qwen **78/100**,
**300/400**; medium **95/100**, **326/400**). Not a singleton core.
Last-1 `hashtok2` likewise sits with last-1 hashtok (GPT-2 **97/100**,
**329/400**; Distil **81/100**, **112/400** chance; Qwen **76/100**,
...
python3 -m text_watermark_tools probe experiments/2026-09-01-pair-gpt2-medium-100x4 \
  --model gpt2 --methods hard --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:128,8:128 \
  --out-dir /tmp/kgw-lab/probe-medium-100x4-synthid-k2-mask-tails
...
python3 -m text_watermark_tools probe experiments/2026-09-01-pair-grok36x4 \
  --methods hard --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:128,8:128 \
  --out-dir /tmp/kgw-lab/probe-grok36x4-synthid-k2-mask-tails
...
python3 -m text_watermark_tools probe experiments/2026-09-01-pair-distil-100x4 \
  --model gpt2 --methods hard --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
  --out-dir /tmp/kgw-lab/probe-distil-100x4-synthid-hard-k2-mid
...
python3 -m text_watermark_tools probe experiments/2026-09-03-pair-100x4-ngram13 \
  --methods hard --context-len 2 --skip-hashpool --skip-nested \
  --windows 4:16,16:32,32:64 \
...
python3 -m text_watermark_tools probe experiments/2026-09-04-pair-qwen-100x4-ngram13 \
  --model Qwen/Qwen2-1.5B-Instruct --methods hard --context-len 2 \
  --skip-hashpool --skip-nested \
  --windows 0:4,4:16,16:32,64:128 \
  --out-dir /tmp/kgw-lab/probe-qwen-100x4-ngram13-hard-k2
...
arXiv:2609.02177) is keyed multi-bit scheme design. Sun et al. (2026)
(PROSE; arXiv:2609.02553) fingerprints model ownership from semantic
response templates, not `indicate` on sampling twins. te Lintelo et al.
...
**9/12**, **21/48**. Qwen $\Hw=12$ last-2 ranking is **5/12**. Qwen $\Hw=12$ 100 last-2 is **76/100**, **270/400**, below
last-4 isolated **361/400**; opening **81/100**, tail **67/100**. Do not
sell last-2 **76/100** or interpolate **76/100**. Hashpool last-2 on public 12 is
...
1. Kirchenbauer green-list leak is a **body** leak under last-4
   ...
   **252/400** vs hits **303/400**). Occupancy-free `hashtok` last-1
   ...
   (**98/100**, **314/400**); Distil **98/100**, **295/400**. Later windows
   ...
   SynthID last-2 drop. Last-2 hashtok 32:64 still ranks that body
   (GPT-2 **98/100**, **322/400**; Distil **97/100**, **240/400**).
   Last-2 `hashpool` 32:64 sits with that body (GPT-2 **100/100**,
   **333/400**; Distil **97/100**, **253/400**). Last-2 `hashtok2` 32:64
   sits with last-2 hashtok (GPT-2 **98/100**, **326/400**; Distil
   **98/100**, **257/400**).
...
2. Matching `context_len` to last-1 hash width recovers isolated
   ...
   **93/100**, isolated **252/400**). Aaronson last-2 hard still ranks on
   ...
   (**64/100**). Aaronson last-2 `hashpool` ranks with last-2 hits, not
   last-2 hard (Qwen 4:16 **96/100** vs hard **64/100**; GPT-2
   **99/100**; Distil **95/100**). Isolated is weaker than hits (Qwen
   **236/400** vs **276/400**, **37** ranking-only; GPT-2 **348/400**
   vs **388/400**). Last-2 `interpolate` ranks with last-1 interpolate,
   not last-2 hits isolated (GPT-2 4:16 **98/100**, **280/400**, **28**
   ...
   **9** ranking-only); Distil **97/100**, **360/400**; Qwen **94/100**,
   ...
   **364/400**) and Distil (**94/100**, **352/400**). Qwen last-2
   ...
   still below last-1 hashtok **304/400**. Last-2 hashtok 32:64 on Qwen
   still ranks **95/100** with isolated **208/400** (**43** ranking-only)
   versus last-1 **100/100**, **324/400**. Last-2 `hashpool` 32:64 still
   ranks (GPT-2 **97/100**, **320/400**; Distil **92/100**, **332/400**;
   Qwen **99/100**, **240/400**, **39** ranking-only) versus last-2 hits
   isolated (Qwen **356/400**). Last-2 `hashtok2` 32:64 sits with last-2
   hashtok on GPT-2 (**96/100**, **332/400**) and Distil (**89/100**,
   **324/400**). Qwen last-2 hashtok2 32:64 **94/100**, **320/400**,
   **14** ranking-only recovers from last-2 hashtok **208/400**,
   **43** ranking-only and sits with last-1 hashtok 32:64 **324/400**,
   still below last-2 hits **356/400**. Do not sell Qwen **320/400**.
   ...
   **31/100**, **12/400**). Do not sell Aaronson
   ranking **98/100**, hashpool **99/100**, last-2 hashpool Qwen
   **96/100** / **236/400**, last-2 hashpool 32:64 Qwen **99/100** /
   **240/400**, last-2 hashtok2 32:64 Qwen **94/100** / **320/400**,
   unigram **73/100**, Qwen
...
3. On public SynthID $\Hw=4$, the existing `hard` reader is stronger at
   ...
   **346/400**; medium **98/100**, **338/400**), not last-2 hard
   ...
   Distil, isolated **294/400**. Last-2 `interpolate` GPT-2 4:16
   **93/100**, **321/400** sits with last-4 interpolate **94/100**,
   ...
   **294/400**. gpt2-medium last-2 hashtok **96/100**, **333/400** sits
   with GPT-2 last-2 hashtok **98/100**. Last-2 `hashtok2` sits with
   last-2 hashtok (GPT-2 **98/100**, **340/400**; Distil **71/100**,
   **123/400** chance; Qwen **78/100**, **300/400**; medium **95/100**,
   **326/400**). Last-1 `hashtok2` sits with last-1 hashtok (GPT-2
   **97/100**, **329/400**; Distil **81/100**, **112/400** chance; Qwen
   **76/100**, **313/400**; medium **95/100**, **327/400**). Do not switch Distil/Qwen occupancy-free hashing to
   last-2 or to `hashtok2`. Distil last-2 4:16 is chance (**58/100**). Qwen last-2
   ...
   **89/100** (n=100), Qwen2-1.5B $\Hw=12$ last-2 ranking **5/12**, and
   Qwen $\Hw=12$ 100 last-2 **76/100**, **270/400** (not last-4
   **74/100**, **361/400**; not interpolate **76/100**). Distil $\Hw=12$ interpolate last-4 is front-loaded
