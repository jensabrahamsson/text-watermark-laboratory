...
def test_witten_bell_and_rankpath_are_specified() -> None:
    ...
    assert "PROTOCOL-isolated-rankpath-g2d" in next_sec
    assert "d62c732" in next_sec
    assert "PROTOCOL-isolated-rankpath-m2d" in next_sec
    assert "571d4f1" in next_sec
    assert "PROTOCOL-isolated-rankpath-body" in next_sec
    assert "dbc61c5" in next_sec
    assert "PROTOCOL-isolated-rankpath-dbody" in next_sec
    assert "68b0514" in next_sec
    assert "PROTOCOL-isolated-rankpath-mbody" in next_sec
    ...
    assert "PROTOCOL-isolated-rankpath-mid" in next_sec
    assert "14afbd5" in next_sec
...
def test_readme_matches_revised_title() -> None:
    ...
    assert "PROTOCOL-isolated-rankpath-g2d" in README
    assert "d62c732" in README
    assert "PROTOCOL-isolated-rankpath-m2d" in README
    assert "571d4f1" in README
    assert "PROTOCOL-isolated-rankpath-body" in README
    assert "dbc61c5" in README
    assert "PROTOCOL-isolated-rankpath-dbody" in README
    assert "68b0514" in README
    assert "PROTOCOL-isolated-rankpath-mbody" in README
    ...
    assert "PROTOCOL-isolated-rankpath-mid" in README
    assert "14afbd5" in README
