...
(`2577771`). Ranking **6/12**, isolated **22/48 vs 30/48**. Do not sell
...
(`b3fd331`). Ranking **11/12**, isolated **30/48 vs 31/48**. Do not sell
**30/48**. GPT-2-small LM on Distil 12×4 is named in
[research/PROTOCOL-isolated-rankpath-g2d.md](research/PROTOCOL-isolated-rankpath-g2d.md)
(`d62c732`). Ranking **6/12**, isolated **24/48 vs 27/48**. Do not sell
**24/48**. gpt2-medium LM on Distil 12×4 is named in
[research/PROTOCOL-isolated-rankpath-m2d.md](research/PROTOCOL-isolated-rankpath-m2d.md)
(`571d4f1`). Ranking **9/12**, isolated **30/48 vs 33/48**. Do not sell
**30/48**. Opening rankpath on generated tokens `[4:16)` is named in
[research/PROTOCOL-isolated-rankpath-body.md](research/PROTOCOL-isolated-rankpath-body.md)
(`dbc61c5`). Ranking **7/12**, isolated **20/48 vs 22/48**. Do not sell
**20/48**. Distil-LM rankpath on generated tokens `[4:16)` is named in
[research/PROTOCOL-isolated-rankpath-dbody.md](research/PROTOCOL-isolated-rankpath-dbody.md)
(`68b0514`). Ranking **6/12**, isolated **24/48 vs 23/48**. Do not sell
**24/48**. gpt2-medium-LM rankpath on generated tokens `[4:16)` is named in
[research/PROTOCOL-isolated-rankpath-mbody.md](research/PROTOCOL-isolated-rankpath-mbody.md)
(`3ea80e4`). Ranking **9/12**, isolated **27/48 vs 28/48**. Do not sell
**27/48**. Distil native rankpath on generated tokens `[4:16)` is named in
[research/PROTOCOL-isolated-rankpath-d12body.md](research/PROTOCOL-isolated-rankpath-d12body.md)
(`468a66b`). Ranking **9/12**, isolated **25/48 vs 30/48**. Do not sell
...
(`08b89ee`). Ranking **4/12**, isolated **26/48 vs 21/48**. Do not sell
...
**25/48** is not a win. GPT-2-small LM rankpath on gpt2-medium generated
