...
([PROTOCOL-next-longctx.md](PROTOCOL-next-longctx.md)). Leave-one-out
interpolate occupancy is lower under $\Hw=12$ than public $\Hw=4$
(original-12 **160** vs **269** seen; 100 families **5878** vs
**10158**). `used_keys=false`
for those key-free readers. Do not sell **76/100**, **160**, or
**5878** as replacing **25/48**.
