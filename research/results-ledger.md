...
GPT-2-small LM opening rankpath on Distil 12×4 is
[PROTOCOL-isolated-rankpath-g2d.md](PROTOCOL-isolated-rankpath-g2d.md)
(`d62c732`): ranking **6/12**, isolated **24/48 vs 27/48**. H-rpg2d
**holds**. Do not sell **24/48**. Isolated-file remains open.
gpt2-medium LM opening rankpath on Distil 12×4 is
[PROTOCOL-isolated-rankpath-m2d.md](PROTOCOL-isolated-rankpath-m2d.md)
(`571d4f1`): ranking **9/12**, isolated **30/48 vs 33/48**. H-rpm2d
**fails** as a raw count. Do not sell **30/48**. Isolated-file remains open.
...
(`68b0514`): ranking **6/12**, isolated **24/48 vs 23/48**. H-rpdbody
**holds**. Do not sell **24/48**. Isolated-file remains open.
...
gpt2-medium native rankpath on generated tokens `[4:16)` is
[PROTOCOL-isolated-rankpath-m12body.md](PROTOCOL-isolated-rankpath-m12body.md)
(`37a2c43`): ranking **6/12**, isolated **20/48 vs 30/48**. H-rpm12body
**holds**. Do not sell **20/48**. Isolated-file remains open.
GPT-2-small LM rankpath on Distil generated tokens `[4:16)` is
[PROTOCOL-isolated-rankpath-g2dbody.md](PROTOCOL-isolated-rankpath-g2dbody.md)
(`08b89ee`): ranking **4/12**, isolated **26/48 vs 21/48**. H-rpg2dbody
**fails** as a raw count. Do not sell **26/48**. Isolated-file remains open.
Distil LM rankpath on gpt2-medium generated tokens `[4:16)` is
...
(`e677a6c`): ranking **8/12**, isolated **28/48 vs 30/48**. H-rpg2mbody
**fails** as a raw count. Do not sell **28/48**. Isolated-file remains open.
gpt2-medium LM rankpath on Distil generated tokens `[4:16)` is
[PROTOCOL-isolated-rankpath-m2dbody.md](PROTOCOL-isolated-rankpath-m2dbody.md)
(`a550cb6`): ranking **9/12**, isolated **32/48 vs 25/48**. H-rpm2dbody
**fails** as a raw count. Do not sell **32/48**. Isolated-file remains open.
GPT-2 rankpath on generated tokens `[16:32)` is
[PROTOCOL-isolated-rankpath-mid.md](PROTOCOL-isolated-rankpath-mid.md)
(`14afbd5`): ranking **7/12**, isolated **23/48 vs 26/48**. H-rpmid
**holds**. Do not sell **23/48**. Isolated-file remains open.
