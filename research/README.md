...
| [key-free-hashtok.md](key-free-hashtok.md) | Occupancy-free hashpool: prefix-5 hashtok **30/48**; mixed backoff t=0 **38/48** is short prefixes; exact `hashtoklenbackoff` nested Youden **33/48**; letter d2 fifth is last-1 unmarked |
