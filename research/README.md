...
| [key-free-hashtok.md](key-free-hashtok.md) | Occupancy-free hashpool: 60-stem prefix-5 hashtok **30/48** equals postokhits; hashpool's extra 4 (letter d2) are Laplace |
...
**occupancy vs observed next token → `tokhits` / `postokhits` / `hashtok`**  
