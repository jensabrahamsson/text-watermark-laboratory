...
| [key-free-hashtok.md](key-free-hashtok.md) | Occupancy-free hashpool: prefix-5 hashtok **30/48** equals postokhits; hashed backoff t=0 **38/48**, nested Youden **30/48**; letter d2 fifth token is last-1 unmarked |
...
**occupancy vs observed next token → `tokhits` / `postokhits` / `hashtok` / `hashtokbackoff`**  
