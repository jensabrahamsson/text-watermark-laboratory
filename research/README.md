...
| [PROTOCOL-isolated-windows.md](PROTOCOL-isolated-windows.md) | 100→Grok lock A is not front-loaded (tail **9/12**; 0:4 **7/12**) |
...
| [narrative.md](narrative.md) | Two-grain story lock; rejects a “key-free detection fails” title; Christ/Zhang slogans are not this mixin; not `thesis/` |
...
| [related-work.md](related-work.md) | Narrative related work; Christ/Zhang slogans ≠ this mixin; author–year |
